...
export default async function SavedTopicsPage() {
  ...
  // ดึงข้อมูลกระทู้ที่ User นี้กด Bookmark ไว้
  // ต้อง JOIN ตาราง topics กับ bookmarks เข้าด้วยกัน
    ...
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800 dark:bg-black dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="container mx-auto p-6 max-w-5xl">
        ...
        <div className="flex items-center gap-4 mb-8">
            <Link href="/profile" className="text-gray-500 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-400 text-2xl">
                &larr;
            </Link>
